...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // expr
      // tipo
      char dummy1[sizeof (AbstractExp*)];

      // imprimir
      char dummy2[sizeof (NT_Imprimir*)];

      // lSentencia
      char dummy3[sizeof (NT_LSentencias*)];

      // lista_Expr
      char dummy4[sizeof (NT_ListaExpr*)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_s = 25,                                // s
        S_lSentencia = 26,                       // lSentencia
        S_sentencia = 27,                        // sentencia
        S_lista_Expr = 28,                       // lista_Expr
        S_imprimir = 29,                         // imprimir
        S_bloque = 30,                           // bloque
        S_z = 31,                                // z
        S_declaracion_var = 32,                  // declaracion_var
        S_asignacion_var = 33,                   // asignacion_var
        S_expr = 34,                             // expr
        S_tipo = 35                              // tipo
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_tipo: // tipo
        value.move< AbstractExp* > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_lista_Expr: // lista_Expr
        value.move< NT_ListaExpr* > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, AbstractExp*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const AbstractExp*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, NT_ListaExpr*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const NT_ListaExpr*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_expr: // expr
      case symbol_kind::S_tipo: // tipo
        value.template destroy< AbstractExp* > ();
        break;
      ...
      case symbol_kind::S_lista_Expr: // lista_Expr
        value.template destroy< NT_ListaExpr* > ();
        break;
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_expr: // expr
      case symbol_kind::S_tipo: // tipo
        value.copy< AbstractExp* > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_lista_Expr: // lista_Expr
        value.copy< NT_ListaExpr* > (YY_MOVE (that.value));
        break;
  ...
  Parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_expr: // expr
      case symbol_kind::S_tipo: // tipo
        value.move< AbstractExp* > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_lista_Expr: // lista_Expr
        value.move< NT_ListaExpr* > (YY_MOVE (s.value));
        break;
