  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_s = 28,                                // s
        S_lSentencias = 29,                      // lSentencias
        S_sentencia = 30,                        // sentencia
        S_if = 31,                               // if
        S_markIF = 32,                           // markIF
        S_markIF2 = 33,                          // markIF2
        S_else = 34,                             // else
        S_while = 35,                            // while
        S_markWhile1 = 36,                       // markWhile1
        S_markWhile2 = 37,                       // markWhile2
        S_cond = 38,                             // cond
        S_markOR = 39,                           // markOR
        S_markAND = 40,                          // markAND
        S_operel = 41,                           // operel
        S_expr = 42                              // expr
      };
    };
